                ...
                {notifications.length === 0 ? (
                  ...
                  notifications.map((notif) => (
                    <div
                      ...
                      className={`p-4 flex gap-3 hover:bg-slate-50 transition relative group cursor-pointer ${!notif.isRead ? "bg-blue-50/20" : ""
                        }`}
                    >
                      ...
                      <div className="flex-1 space-y-1 pr-4 font-sans">
                        <p
                          className={`text-xs leading-relaxed wrap-break-word ${!notif.isRead ? "text-slate-900 font-medium" : "text-slate-600"
                            }`}
                        >
                          {notif.message}
                        </p>
