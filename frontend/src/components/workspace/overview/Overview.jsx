      ...
      <div className="p-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-slate-500">Track progress, manage tasks, and collaborate efficiently.</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mt-8">
          ...
          <div className="rounded-2xl border border-slate-200 p-5 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
            ...
            <p className="text-3xl font-bold mt-3">{totalTasks - completedTasks}</p>
          </div>
        </div>
