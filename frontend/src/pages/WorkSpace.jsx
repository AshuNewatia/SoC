      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-8">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="h-5 w-96 bg-slate-100 rounded mt-4"></div>
          </div>
        ...
        <div className="mt-10">
          ...
          <div className="h-3 bg-slate-100 rounded-full mt-4"></div>

          <div className="h-4 w-32 bg-slate-100 rounded mt-4"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mt-10">
          {[1, 2, 3, 4].map((item) => (
            ...
            >
              ...
              <div className="h-10 w-12 bg-slate-300 rounded mt-5"></div>
            </div>
          ))}
        </div>
      </div>
